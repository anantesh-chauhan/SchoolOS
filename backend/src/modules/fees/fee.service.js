...
export const listStructures = (user, academicSession) =>
...
export const publishStructure = (req, id) =>
  prisma.$transaction(async (tx) => {
    ...
    if (!existing)
      throw Object.assign(new Error("Draft fee structure not found"), {
        status: 404,
      });
...
export const getStudentFees = async (
  ...
  return json({
    ...
    assignedStructure: assignments[0]?.feeStructure || null,
