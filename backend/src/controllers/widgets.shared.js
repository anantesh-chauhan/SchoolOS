...
export const dayDiff = (left, right) => {
...
export const buildSummaryWidgets = async ({ schoolId, userId }) => {
...
export const buildDashboardWidgets = (role, data) => {
...
export const handleCrud = (model, schoolId, userId, req, res, mapCreate, mapUpdate) => {
