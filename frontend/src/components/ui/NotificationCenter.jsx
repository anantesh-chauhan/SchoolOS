...
export default function NotificationCenter({ enabled = true }) {
  ...
  return (
    <div ref={root} className="relative">
      ...
      {open && <div className="absolute right-0 z-50 mt-2 w-[min(92vw,390px)] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl dark:border-slate-700 dark:bg-slate-900">
